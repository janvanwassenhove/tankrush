import {HABITATS,getHabitat,SPECIES} from './habitats.js?v=12';
import {Simulation,pathPoint} from './simulation.js?v=12';
import {bindJoystick} from './input.js?v=12';
import {t,setLanguage,getLanguage,localizedHabitat} from './i18n.js?v=12';
...
async function ensureView(){
 if(view)return;
 if(!viewPromise)viewPromise=import('./scene.js?v=12').then(({RaceScene})=>{view=new RaceScene($('#game'));view.setQuality($('#quality').value);}).catch(e=>{viewPromise=null;throw e;});
 await viewPromise;
}
