...
export const HABITATS=[
 ...
 {id:'outback',relief:[{x:-60,z:22,rx:44,rz:34,height:19},{x:63,z:-30,rx:39,rz:30,height:12}],kind:'terrarium',name:'Australia · Red Centre',region:'Australië',shape:'rectangle',shapeLabel:'Breed woestijnterrarium',size:'120 × 72 × 50 cm',halfWidth:120,halfDepth:72,height:100,trackX:90,trackZ:48,wobble:6,phase:.4,theme:'outback',course:'mesa',animalCount:9,plants:8,rocks:25,branches:4,seed:606,roster:['beardie','skink','monitor'],description:'Rode zandhellingen, berijdbare rotsruggen en zonwarme plateaus.',palette:palette(0xbb7549,0x9d6241,0x94954e,0x775642,0xffcf83,0xf5b25d)},
 {id:'sonora',relief:[{x:44,z:27,rx:38,rz:30,height:15},{x:-52,z:-24,rx:36,rz:29,height:11}],kind:'terrarium',name:'Sonora · Desert Afterglow',region:'Noord-Amerika',shape:'rectangle',shapeLabel:'Laag zandterrarium',size:'110 × 64 × 45 cm',halfWidth:106,halfDepth:62,height:86,trackX:78,trackZ:40,wobble:4,phase:2,theme:'desert',course:'cactus',animalCount:9,plants:7,rocks:17,branches:3,seed:707,roster:['bandedgecko','scorpion','tarantula'],description:'Golvende duinen, rotshellingen, schuilholen en warm avondlicht.',palette:palette(0xd4b889,0xb29d78,0x779070,0x745d48,0xffd9aa,0xeac391)},
 {id:'madagascar',relief:[{x:-30,z:30,rx:32,rz:32,height:17},{x:30,z:-32,rx:30,rz:32,height:12}],pools:[{x:42,z:24,rx:15,rz:20,level:3,depth:.8}],kind:'terrarium',name:'Madagascar · Canopy Cube',region:'Afrika · Madagaskar',shape:'cube',shapeLabel:'Hoog glazen kubusterrarium',size:'60 × 60 × 60 cm',halfWidth:80,halfDepth:80,height:160,trackX:55,trackZ:55,wobble:3,phase:1.6,theme:'canopy',course:'clover',animalCount:10,plants:44,rocks:8,branches:12,seed:808,roster:['panther','daygecko'],description:'Begroeide hellingen, een ondiepe poel en kameleons boven de racelijn.',palette:palette(0x5c4930,0x61714e,0x529451,0x264a35,0xe6f4b8,0xaadf64)},
 {id:'costarica',relief:[{x:48,z:28,rx:40,rz:35,height:21},{x:35,z:-38,rx:36,rz:30,height:13}],pools:[{x:-49,z:-31,rx:20,rz:19,level:3,depth:.9},{x:-64,z:-17,rx:17,rz:23,level:3,depth:.9},{x:-73,z:7,rx:16,rz:25,level:3,depth:.8}],kind:'terrarium',name:'Costa Rica · Cloud Falls',region:'Midden-Amerika',shape:'paludarium',shapeLabel:'Hoog paludarium',size:'90 × 64 × 65 cm',halfWidth:108,halfDepth:76,height:156,trackX:78,trackZ:50,wobble:5,phase:3.4,theme:'waterfall',course:'cascade',animalCount:11,plants:49,rocks:19,branches:7,seed:909,roster:['treefrog','dartfrog','viper'],waterfall:{x:-49,z:-31,height:74,pool:13},description:'Rotsklimmen, een waterval en drie verbonden waadpoelen tussen de kikkers.',palette:palette(0x574b38,0x58746a,0x399363,0x377f81,0xc8ffe3,0x7ee4c6)},
 {id:'caledonia',relief:[{x:-30,z:-25,rx:32,rz:34,height:18},{x:29,z:30,rx:32,rz:32,height:12}],pools:[{x:40,z:-24,rx:16,rz:19,level:3,depth:.7}],kind:'terrarium',name:'New Caledonia · Fern Spire',region:'Oceanië',shape:'hexagon',shapeLabel:'Zeshoekig bosterrarium',size:'70 × 64 × 67 cm',halfWidth:90,halfDepth:82,height:172,trackX:54,trackZ:48,wobble:3,phase:4.1,theme:'ferns',course:'spiral',animalCount:9,plants:48,rocks:12,branches:14,seed:1010,roster:['crestedgecko'],description:'Varens op heuvelruggen, een kleine bospoel en wimpergekko’s tussen kurkstammen.',palette:palette(0x70553b,0x687365,0x83ab52,0x3c4c3c,0xffedbd,0xcddd8b)}
];
