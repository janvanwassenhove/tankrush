const CACHE='tankrush-v11';
const ASSETS=['./previews/amazon.webp','./previews/asia.webp','./previews/malawi.webp','./previews/reef.webp','./previews/jelly.webp','./previews/outback.webp','./previews/sonora.webp','./previews/madagascar.webp','./previews/costarica.webp','./previews/caledonia.webp','./','./index.html','./style.css?v=11','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./src/main.js?v=11','./src/input.js?v=11','./src/simulation.js?v=11','./src/scene.js?v=11','./src/models.js?v=11','./src/assets.js?v=11','./vendor/three/three.module.js','./vendor/three/three.core.js','./vendor/three/addons/loaders/GLTFLoader.js','./vendor/three/addons/utils/BufferGeometryUtils.js','./models/submarine.glb','./models/buggy.glb','./models/guppy.glb','./models/piranha.glb','./models/spider.glb','./models/snake.glb','./models/monitor.glb','./models/chameleon.glb','./src/habitats.js?v=11','./src/decor.js?v=11','./src/creatures.js?v=11','./models/tetra.glb','./models/discus.glb','./models/rasbora.glb','./models/gourami.glb','./models/cichlid.glb','./models/clownfish.glb','./models/tang.glb','./models/shrimp.glb','./models/jellyfish.glb','./models/bearded.glb','./models/skink.glb','./models/gecko.glb','./models/crested.glb','./models/frog.glb','./models/scorpion.glb'];
