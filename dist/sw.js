const CACHE='tankrush-v14';
const ASSETS=['./src/i18n.js?v=14','./previews/amazon.webp','./previews/asia.webp','./previews/malawi.webp','./previews/reef.webp','./previews/jelly.webp','./previews/outback.webp','./previews/sonora.webp','./previews/madagascar.webp','./previews/costarica.webp','./previews/caledonia.webp','./','./index.html','./style.css?v=14','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./src/main.js?v=14','./src/input.js?v=14','./src/simulation.js?v=14','./src/scene.js?v=14','./src/models.js?v=14','./src/assets.js?v=14','./vendor/three/three.module.js','./vendor/three/three.core.js','./vendor/three/addons/loaders/GLTFLoader.js','./vendor/three/addons/utils/BufferGeometryUtils.js','./models/submarine.glb','./models/buggy.glb','./models/guppy.glb','./models/piranha.glb','./models/spider.glb','./models/snake.glb','./models/monitor.glb','./models/chameleon.glb','./src/habitats.js?v=14','./src/decor.js?v=14','./src/creatures.js?v=14','./models/tetra.glb','./models/discus.glb','./models/rasbora.glb','./models/gourami.glb','./models/cichlid.glb','./models/clownfish.glb','./models/tang.glb','./models/shrimp.glb','./models/jellyfish.glb','./models/bearded.glb','./models/skink.glb','./models/gecko.glb','./models/crested.glb','./models/frog.glb','./models/scorpion.glb'];
